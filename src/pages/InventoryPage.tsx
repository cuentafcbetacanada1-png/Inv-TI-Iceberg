      ...
      <div className="grid grid-cols-1 gap-6">
         ...
         {filteredEquipos.length === 0 && (
           <div className="flex flex-col items-center justify-center p-20 border-2 border-dashed border-[#0e312a] rounded-[2.5rem] space-y-4">
              <AlertCircle size={48} className="text-[#0e312a]" />
              <p className="text-xs font-black text-[#4e564e] uppercase tracking-widest italic">No se encontraron registros en la Matriz</p>
           </div>
         )}
      </div>
    </div>
