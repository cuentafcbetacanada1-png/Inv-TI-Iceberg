...
const ProtectedRoute: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  if (isLoading) {
    return (
      <div className="h-screen w-screen flex items-center justify-center bg-obsidian-950 font-sans overflow-hidden">
        <div className="absolute inset-0 bg-mesh opacity-20" />
        <div className="flex flex-col items-center gap-12 relative z-10">
          <div className="relative">
             <div className="w-24 h-24 border-2 border-primary-500/20 rounded-full animate-ping absolute inset-0" />
