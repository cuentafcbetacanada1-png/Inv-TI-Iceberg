...
const DashboardLayout: React.FC = () => {
  ...
  return (
    <div className="flex h-screen bg-[#090a09] font-sans text-white overflow-hidden selection:bg-[var(--primary)]/30">
      {/* Sidebar Compacto */}
      <aside className="w-60 bg-[#090a09] border-r border-[#0e312a]/40 flex flex-col p-6 z-30">
        <div className="flex items-center gap-2 mb-10 px-1">
           <div className="w-8 h-8 bg-[var(--primary)] rounded-lg flex items-center justify-center shadow-[0_0_15px_var(--primary-glow)] rotate-3">
        ...
        <div className="mt-auto space-y-4">
           <div className="p-4 rounded-2xl bg-[#0e312a]/10 border border-[var(--primary)]/5 relative overflow-hidden group hover:border-[var(--primary)]/20 transition-all backdrop-blur-md">
              <div className="absolute -right-3 -top-3 w-10 h-10 bg-[var(--primary)]/5 rounded-full blur-xl" />
              <div className="w-7 h-7 rounded-lg bg-[var(--primary)]/10 flex items-center justify-center text-[var(--primary)] mb-2">
                 <Bell size={14} />
              </div>
          ...
          <div className="flex items-center gap-5">
             ...
             <div className="flex items-center gap-3 bg-[#121412]/50 px-4 py-2 rounded-xl border border-[#0e312a]/30 w-72 focus-within:border-[var(--primary)]/40 transition-all backdrop-blur-xl">
                ...
                <input 
                  ...
                  className="bg-transparent border-none outline-none text-[10px] w-full placeholder:text-[#2a302a] font-semibold uppercase tracking-widest text-[var(--primary)]"
                />
             </div>
          </div>
